...
{
    "require": {
       "paldraken/yii2-gearman": "dev-master"
    }
}
```
...
'components' => [
  'gearman' => [
      'class' => 'paldraken\yii2\gearman\GearmanComponent',
      'servers' => [
...
'controllerMap' => [
    'gearman' => [
        'class' => 'paldraken\yii2\gearman\GearmanController',
...
use paldraken\yii2\gearman\JobBase;
